...
RESPONSE FORMAT (JSON):
{
    ...
    "tripInfo": {
        ...
        "arrivalAirport": "airport name or null",
        "departureAirport": "airport name or null",
        "arrivalTimePreference": "h:mm AM/PM time string or null",
        "departureTimePreference": "h:mm AM/PM time string or null"
    },
    ...
    "popularOptions": [
      {
        ...
        "isDurationFlexible": "true|false (set false for fixed-length experiences like guided tours, timed tickets, classes, or performances; true when duration can flex)",
        ...
        "daylightPreference": "daylight_only|night_only|flexible (set based on actual conditions; e.g., most snorkeling is daylight_only, night snorkeling/stargazing is night_only)",
