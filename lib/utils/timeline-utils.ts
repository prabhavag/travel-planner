...
export const MIN_SCHEDULED_DURATION_RATIO = 0.5;        // never schedule below 50% of recommended
...
/**
 * Any parseable fixed-start label should anchor scheduling, including
 * symbolic anchors like "sunrise"/"sunset".
 */
